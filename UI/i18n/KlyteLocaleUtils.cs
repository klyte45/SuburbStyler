...
namespace Klyte.SuburbStyler.i18n
{
    public abstract class KlyteLocaleUtils<T, R> : Singleton<T> where T : KlyteLocaleUtils<T, R> where R : KlyteResourceLoader<R>
    {
        ...
        internal static SavedInt currentLanguageId => new SavedInt("SuburbStylerLanguage", Settings.gameSettingsFile, 0, true);
        ...
        protected readonly string[] locales = new string[] { "en", "pt", "de" };
